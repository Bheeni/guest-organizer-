...
function submit() { var display_student_array = [];
     
    for (var j = 1; j <= 4; j++) { var name_of_the_student = document.getElementById("name_of_the_guest_"+j).value; 
...
} function sorting(){ name_of_the_student.sort(); 
